...
if __name__ == "__main__":
    ...
    wr =pyNJOY2GENDF.njoy2gendf.njoy2gendf(savedir='endfb8_gendf_library', # path to save the files to 
                    path2endf='ENDFB8_data/neutrons',                      # folder of raw data 
    ...
    wr.write_njoy_gendf_inputs(
        ...
        library_name='ENDF-B-VIII.0', # this is cosmetic i.e. not relevant to calcualtions 
